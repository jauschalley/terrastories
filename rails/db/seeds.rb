...
Story.find_or_create_by(title: "Rudo's testimonial",
                     desc: "ACT program manager Rudo Kemper on why the organization decided to start building Terrastories to support local communities retain their oral history traditions.",
                     speaker: rudo,
                     point: rbtb2019,
                     permission_level: 0)

Story.find_or_create_by(title: "Kalimar's testimonial",
                     desc: "Mapbox sales engineer on why it is important for a company like Mapbox to support open source projects like Terrastories",
                     speaker: kalimar,
                     point: rfg2018,
                     permission_level: 1)
